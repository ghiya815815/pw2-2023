    ...
    <form class="form-horizontal w-75 mt-5 mx-auto p-4 border shadow-sm" method= "POST" action="data_nilai.php" >
        <div class="container px-3">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-8">
                    <input id="nilai_uas" type="number" min="0" max="100" class="form-control" name="uas"placeholder="Masukan angka..." required>
                </div>
            </div>
            <div class="form-group row mb-3">
                <label for="nilai_tugas" class="col-4 col-form-label">Nilai Praktikum</label>
                <div class="col-8">
                    <input id="nilai_tugas" type="number" min="0" max="100" class="form-control" name="paktek"placeholder="Masukan angka..." required>
                </div>
            </div>
            <div class="form-group row mb-3">
