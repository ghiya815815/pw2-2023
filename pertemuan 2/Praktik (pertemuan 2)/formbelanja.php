...
<body>
    ...
    if (isset($_GET['submit'])) {
        $submit = $_GET['submit']; //di ambil  dari name= "yangdidalamnya" dalam input
        $custname = $_GET['custname']; //di ambil  dari name= "yangdidalamnya" dalam input
        $produk = $_GET['produk']; //di ambil  dari name= "yangdidalamnya" dalam input
        $jumlah = $_GET['jumlah']; //di ambil  dari name= "yangdidalamnya" dalam input

        switch ($produk) {
            case "baju": //ambil dari value
                $total = $jumlah * 100000;
                break;
            case "topi": //ambil dari value
                $total = $jumlah * 20000;
                break;
            case "jamtangan": //ambil dari value
                $total = $jumlah * 150000;
                break;
        }
